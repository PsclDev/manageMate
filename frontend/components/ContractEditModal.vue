...
const { editContract } = useContractStore();
...
const state = reactive<Schema>({
  ...
  expiresAt: contract.expiresAt.toISOString().slice(0, 10),
  lastTerminationDate: contract.lastTerminationDate.toISOString().slice(0, 10),
});
